...
class OfflineAccountsRepository(
    ...
    override fun getAllFullAccountsStream(): Flow<List<FullAccount>> = accountDao.getAllFullAccounts()
    ...
    override suspend fun registerTransfer(transfer: Transfer) = transactionsRepository.insertTransfer(transfer)
}
