...
class BalancesRepositoryTest{
    ...
    fun setup(){
        ...
        transactionsRepository = OfflineTransactionsRepository(
            transactionDao
        )

        accountRepository = OfflineAccountsRepository(
            accountDao,
            currenciesRepository,
            transactionsRepository
        )

        futureTransactionsRepository = OfflineFutureTransactionsRepository(
    ...
    fun testSimpleTransactions() = runBlocking {
        ...
        assertTrue("The generated transactions must be cropped", offlineBalancesRepository.getPendingTransactions(
        ...
        assertTrue("All transactions must be generated", offlineBalancesRepository.getPendingTransactions(
            LocalDateTime.parse("2024-08-31T12:00:00").toLocalDate(),
