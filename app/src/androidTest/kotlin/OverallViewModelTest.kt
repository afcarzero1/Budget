...
class OverallViewModelTest {
    ...
    private val currentBalances =
        mapOf(
            YearMonth.of(2023, 1) to
                mapOf(
    ...
    private val balancesRepository: MockBalancesRepository =
